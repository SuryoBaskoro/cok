...
@section('content')
    ...
    @if (Auth::user()->status == 'A')
        <div class="callout callout-info">
            ...
            <p>Selamat Datang! Semoga Harimu Menyenangkan!</p>
        </div>
    @endif
    @if (Auth::user()->status == 'A' || Auth::user()->status == 'G')
        ...
        {{-- <div class="col-md-4">
                                ...
                                <li class="item">
                                    <div class="product-img">
                                        @if ($data_aktifitas->dataAktifitasUser->gambar != '')
                                            <img src="{{ url('/assets/img/user/' . $data_aktifitas->dataAktifitasUser->gambar) }}"
                                                alt="user img">
                                        @else
                                    ...
                                    <div class="product-info">
                                        <a href="javascript:void(0)"
                                            class="product-title">{{ $data_aktifitas->dataAktifitasUser->nama }}
                                            <span
                                                class="label label-warning pull-right">{{ $data_aktifitas->created_at->diffForHumans() }}</span>
                                        </a>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    <p>Terimakasih telah menggunakan aplikasi ujian (<b>TiXam</b>) dari <a href="https://tipa.co.id"
                            target="_blank">Tipamedia</a> ini. Untuk melakukan update sangat disarankan menggunakan
                        <i>git</i> dengan mengetikan <br><i>git pull origin master</i>.</p>
                    <p>Jangan lupa untuk berikan bintang di <a href="https://github.com/wisnuvb/tixam"
                            target="_blank">github tixam</a> ya, supaya lebih banyak lagi yang bisa mengetahui dan
                        menggunakan tixam.</p>
                </div>
            </div>
        </div> --}}
    @else
        <div class="alert" style="background: #fff; border: solid thin #d8d5d5;">
            <p>Hai {{ Auth::user()->nama }}, Selamat datang di TiXam. Disini kamu bisa temukan materi yang telah disiapkan
                oleh Guru serta mengerjakan soal latihan dan ujian.</p>
            <p>Pantau perkembangan kamu dengan melihat nilai-nilai latihan dan ujian dengan cepat.</p>
            <p>Apabila ada hal yang kurang dipahami, bisa ditanyakan kepada Guru atau operator sekolah yang mengelola
                aplikasi ini.</p>
        </div>
    @endif
@endsection
