...
@section('content')
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <button type="button" id="btn-soal" class="btn btn-primary btn-md"><i class="fa fa-pencil-square-o"></i>
                    &nbsp;Tulis Soal</button>
                <a href="{{ url('/download-file-format/soal') }}" class="btn btn-success btn-md"><i
                        class="fa fa-file-excel-o"></i> &nbsp;Download Format Exel</a>
                <button type="button" id="btn-upload-soal" class="btn btn-info btn-md"><i class="fa fa-cloud-upload"></i>
                    &nbsp;Upload Exel</button>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="paket"
                                        placeholder="Tryout Bahasa Indonesia Kelas XIB">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="deskripsi" class="form-control"
                                        placeholder="Tryout dengan lingkup materi: Mengidentifikasi Informasi dalam Teks Ekplanasi"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="kkm" class="col-sm-2 control-label">KKM</label>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control numOnly" data-toggle="tooltip"
                                        title="Nilai Kriteria Ketuntasan Minimal (KKM)" name="kkm" placeholder="70">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control numOnly" data-toggle="tooltip"
                                        title="Masukan waktu ujian dalam satuan menit" name="waktu" placeholder="60">
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="well" style="margin-top: 15px; display: none;" id="wrap-upload-soal">
                    <form class="form-horizontal" action="{{ url('/crud/simpan-detail-soal-via-excel') }}"
                        enctype="multipart/form-data" method="POST">
                        {{ csrf_field() }}
                        <div class="box-body">
                            <div class="form-group">
                                <input type="file" name="file" id="file" class="inputfile" />
                                <label for="file"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Pilih file
                                    excel</label>
                                <p class="help-block">Silahkan pilih file format soal dalam bentuk excel yang telah diisi
                                    dengan benar.</p>
                            </div>
                    ...
                    success: function(data) {
                        ...
                        if (data == 'ok') {
                            ...
                            $("#notif").removeClass('alert alert-danger').addClass(
                                    ...
                                    "<i class='fa fa-info-circle'></i> Data berhasil disimpan.")
                                .fadeIn(350);
