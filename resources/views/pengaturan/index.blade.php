                ...
                @if ($user->status == 'G' or $user->status == 'A')
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tabInfo" data-toggle="tab"><i class="fa fa-user"
                                        aria-hidden="true"></i> Info profil</a></li>
                            <li><a href="#tabSekolah" data-toggle="tab"><i class="fa fa-university" aria-hidden="true"></i>
                                    Info Sekolah</a></li>
                        </ul>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="no_induk" id="no_induk"
                                                    placeholder="NIP" value="{{ $user->no_induk }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="jk" id="laki_laki" value="L"
                                                            <?php if ($user->jk == 'L') {
                                                                echo 'checked';
                                                            } ?>> Laki-laki
                                                    </label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="password" class="form-control" data-toggle="tooltip"
                                                    title="Kosongkan field ini jika tidak ingin merubah password Anda."
                                ...
                                <div class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                @if ($user->gambar != '')
                                                    <img src="{{ url('/assets/img/user/' . $user->gambar) }}" alt="user img"
                                                        width="250px" class="img img-thumbnail"
                                                ...
                                                <form action="{{ url('/crud/simpan-gambar-user') }}" class="dropzone">
                                                    {{ csrf_field() }}
                                                    <input type="hidden" name="id_user_gambar"
                                                        value="{{ $user->id }}">
                                                    <div class="fallback">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <button type="button" class="btn btn-primary btn-md"
                                                    id="update_profil">Update</button>
                                    ...
                                    <form id="formInfoSekolah">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($user->status == 'A')
                                                    <span class="wrap-is" data-toggle="tooltip"
                                                        title="Klik disini untuk merubah data.">{{ $sekolah->nama }}</span>
                                                    <input type="text" name="nama"
                                                        class="form-control info-sekolah" style="display: none;"
                                                        placeholder="Nama sekolah" value="{{ $sekolah->nama }}">
                                                @else
                                                    {{ $sekolah->nama }}
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user->status == 'A')
                                                    <span class="wrap-is" data-toggle="tooltip"
                                                        title="Klik disini untuk merubah data.">{{ $sekolah->motto }}</span>
                                                    <input type="text" name="motto"
                                                        class="form-control info-sekolah" style="display: none;"
                                                        placeholder="Motto sekolah" value="{{ $sekolah->motto }}">
                                                @else
                                                    {{ $sekolah->motto }}
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user->status == 'A')
                                                    <span class="wrap-is" data-toggle="tooltip"
                                                        title="Klik disini untuk merubah data.">{{ $sekolah->alamat }}</span>
                                                    <input type="text" name="alamat"
                                                        class="form-control info-sekolah" style="display: none;"
                                                        placeholder="Alamat sekolah" value="{{ $sekolah->alamat }}">
                                                @else
                                                    {{ $sekolah->alamat }}
                                                @endif
                                            </td>
                                        ...
                                        <tr style="display: none;">
                                            ...
                                            <td>
                                                @if ($user->status == 'A')
                                                    <span class="wrap-is" data-toggle="tooltip"
                                                        title="Klik disini untuk merubah data.">{{ $sekolah->kab_kot ? $sekolah->kab_kot : 'belum ada kota/kabupaten' }}</span>
                                                    <input type="text" name="kab_kot"
                                                        class="form-control info-sekolah" style="display: none;"
                                                        placeholder="Kabupaten / Kota sekolah"
                                                        value="{{ $sekolah->kab_kot }}">
                                                @else
                                                    {{ $sekolah->kab_kot }}
                                                @endif
                                            </td>
                                        ...
                                        <tr style="display: none;">
                                            ...
                                            <td>
                                                @if ($user->status == 'A')
                                                    <span class="wrap-is" data-toggle="tooltip"
                                                        title="Klik disini untuk merubah data.">{{ $sekolah->nama_kepsek }}</span>
                                                    <input type="text" name="nama_kepsek"
                                                        class="form-control info-sekolah" style="display: none;"
                                                        placeholder="Nama kepala sekolah"
                                                        value="{{ $sekolah->nama_kepsek }}">
                                                @else
                                                    {{ $sekolah->nama_kepsek }}
                                                @endif
                                            </td>
                                        ...
                                        <tr style="display: none;">
                                            ...
                                            <td>
                                                @if ($user->status == 'A')
                                                    <span class="wrap-is" data-toggle="tooltip"
                                                        title="Klik disini untuk merubah data.">{{ $sekolah->nip_kepsek }}</span>
...
@else
    ...
    <div class="col-md-4">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p>
                    Lengkapi form pengaturan Anda. Beberapa field kemungkinan bersifat mandatory/wajib. Semakin lengkap data
                    Anda akan semakin sempurna aplikasi ini bekerja.
                </p>
                {{-- @if ($user->status == 'G' or $user->status == 'A')
        <p>
                    ...
                    success: function(data) {
                        ...
                        if (data == 'ok') {
                            $("#notif").removeClass('alert alert-danger').addClass(
                                    'alert alert-info').html("Data berhasil diperbaharui.")
                                .fadeIn(350);
                            location.href = "{{ url('/pengaturan') }}";
                        } else {
                            $("#notif").removeClass('alert alert-info').addClass(
                                'alert alert-danger').html(data).fadeIn(350);
                            $("#update_profil").show();
                        }
                    }
                })
