    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                ...
                <span class="logo-mini"><b>SMK</b>3</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>SMKN</b> 3</span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {{ Auth::user()->nama }}
                                        <small><a href="{{ route('logout') }}"><i class="fa fa-sign-out"></i>
                                                <span>Logout</span></a></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="{{ Request::is('home*') == true ? 'active' : '' }}"><a href="{{ url('/home') }}"><i
                    ...
                    @if ($user->status == 'G' or $user->status == 'A')
                        <li class="treeview {{ Request::is('master*') == true ? 'active' : '' }}">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ Request::is('master/guru*') == true ? 'active' : '' }}"><a
                                        href="{{ url('/master/guru') }}"><i class="fa fa-circle-o"></i> Guru</a></li>
                                <li class="{{ Request::is('master/kelas*') == true ? 'active' : '' }}"><a
                                        href="{{ url('/master/kelas') }}"><i class="fa fa-circle-o"></i> Kelas</a>
                                </li>
                                <li class="{{ Request::is('master/siswa*') == true ? 'active' : '' }}"><a
                                        href="{{ url('/master/siswa') }}"><i class="fa fa-circle-o"></i> Siswa</a>
                                </li>
                            </ul>
                        </li>
                        <li class="treeview {{ Request::is('elearning*') == true ? 'active' : '' }}">
                            ...
                            <ul class="treeview-menu">
                                <li class="{{ Request::is('elearning/materi*') == true ? 'active' : '' }}"><a
                                        href="{{ url('/elearning/materi') }}"><i class="fa fa-circle-o"></i>
                                        Materi</a></li>
                                <li class="{{ Request::is('elearning/soal*') == true ? 'active' : '' }}"><a
                                        href="{{ url('/elearning/soal') }}"><i class="fa fa-circle-o"></i> Soal</a>
                                </li>
                                <li class="{{ Request::is('elearning/laporan*') == true ? 'active' : '' }}"><a
                                        href="{{ url('/elearning/laporan') }}"><i class="fa fa-circle-o"></i>
                                        Laporan</a></li>
                            </ul>
                        </li>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{Request::is('cetak/berita-acara*') == true  ? 'active' : '' }}"><a href="{{ url('/cetak/berita-acara') }}"><i class="fa fa-circle-o"></i> Berita Acara</a></li>
                        ...
                        <li class="{{ Request::is('pengaturan*') == true ? 'active' : '' }}"><a
                                href="{{ url('/pengaturan') }}"><i class="fa fa-cog"></i> <span>Pengaturan</span></a>
                        </li>
                    @elseif($user->status == 'S')
                        <li class="{{ Request::is('siswa/materi*') == true ? 'active' : '' }}"><a
                                href="{{ url('siswa/materi') }}"><i class="fa fa-database"></i>
                                <span>Materi</span></a></li>
                        <li class="{{ Request::is('siswa/ujian*') == true ? 'active' : '' }}"><a
                                href="{{ url('siswa/ujian') }}"><i class="fa fa-list"></i> <span>Ujian</span></a>
                        </li>
                    @endif
                    <li class=""><a href="{{ route('logout') }}"><i class="fa fa-sign-out"></i>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2021-{{ date('Y') }} <a href="http://indoswakaryasolusi.com"
                    target="_blank">IndoSwakaryaSolusi</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
